        ...
        [HBSNetWork postUrl:[NSString stringWithFormat:@"%@user/login", HBSNetAdress] parame:params header:nil cookie:nil result:^(id result) {
            ...
            if ([result[@"code"] integerValue] == 200) {
                ...
                if (![EMClient sharedClient].isLoggedIn) {
                    ...
                    [[EMClient sharedClient] asyncLoginWithUsername:result[@"result"][@"user_im"] password:@"123456" success:^{
                        
                    } failure:^(EMError *aError) {
                        [self creatAlertViewOne:@"温馨提示" message:nil sureStr:@"聊天登录失败" sureAction:^(id result) {
