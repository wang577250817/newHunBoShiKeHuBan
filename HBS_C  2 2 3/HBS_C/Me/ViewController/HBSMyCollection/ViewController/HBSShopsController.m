...
- (void)getupData{
    ...
    [HBSNetWork getUrl:[NSString stringWithFormat:@"%@user/%@/collect?user_collect_type=store&iPageItem=20&iPageIndex=0", HBSNetAdress, [ProjectCache getLoginMessage][@"user_id"]] paramaters:paramas header:nil cookie:nil Result:^(id result) {
