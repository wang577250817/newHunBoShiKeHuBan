...
- (void)getupData{
    ...
    [HBSNetWork getUrl:[NSString stringWithFormat:@"%@user/%@/collect?user_collect_type=case&iPageItem=20&iPageIndex=0", HBSNetAdress, [ProjectCache getLoginMessage][@"user_id"]] paramaters:params header:nil cookie:nil Result:^(id result) {
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    wedVC.goods_id = [self.anLiArr[indexPath.row] goods_id];
