...
- (void)payClick{
    ...
    self.payDic = @{@"order_sn":self.orderNumLabel.text, @"order_amount":self.moneyNumLabel.text, @"order_date":self.orderContentLabel.text, @"order_title":self.roderNameLabel.text}.mutableCopy;
