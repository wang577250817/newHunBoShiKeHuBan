...

{
    ...
    if ([self checkWIFI]) {
        ...
        [HBSNetWork getUrl:[NSString stringWithFormat:@"%@cart/%@", HBSNetAdress, [ProjectCache getLoginMessage][@"user_id"]] cookie:nil Result:^(id result) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.blockNum = ^(NSInteger tt){
        ...
        [HBSNetWork putUrl:[NSString stringWithFormat:@"%@cart/%@", HBSNetAdress, [ProjectCache getLoginMessage][@"user_id"]] parame:dic header:@"c02b68e88c44385f56064ce4cd49b319" cookie:nil result:^(id result) {
            if ([result[@"code"] integerValue] == 200) {
...
- (void)tableView:(UITableView *)tableView commitEditingStyle:(UITableViewCellEditingStyle)editingStyle forRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (editingStyle == UITableViewCellEditingStyleDelete) {
        ...
        [HBSNetWork deleteUrl:[NSString stringWithFormat:@"%@cart/%@", HBSNetAdress, [ProjectCache getLoginMessage][@"user_id"]] parame:dic cookie:nil result:^(id result) {
            if ([result[@"code"] integerValue] == 200) {
                [self removeLodingView];
                [self netWorking];
            }
