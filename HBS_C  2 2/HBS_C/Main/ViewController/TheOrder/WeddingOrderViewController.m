...
- (void)netWorking
{
    ...
    [HBSNetWork getUrl:[NSString stringWithFormat:@"%@cart/address/%@", HBSNetAdress, @"1024"] paramaters:nil header:@"stoken" cookie:nil Result:^(id result) {
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
    ...
    UILabel *label = LabelAlloc(10, 5, WIDTH - 20, 20);
    if (_isCar) {
