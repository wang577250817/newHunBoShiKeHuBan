...
- (void)putOrder
{
    ...
    //token header
    NSMutableDictionary *dic = [@{@"user_id":@"1036", @"name":self.nameTextField.text, @"service_time":self.timeTextField.text?self.timeTextField.text:@"", @"phone":self.phoneTextField.text, @"amount":self.dataDic[@"goods_price"], @"goods_id":self.dataDic[@"goods_id"], @"spec_id":@"", @"note":self.liuyanText.text}
                                mutableCopy];
