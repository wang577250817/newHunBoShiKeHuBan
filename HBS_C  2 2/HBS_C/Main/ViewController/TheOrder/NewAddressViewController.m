...
- (void)deleteAction
{
    ...
    [HBSNetWork deleteUrl:[NSString stringWithFormat:@"%@cart/addressDelete/%@", HBSNetAdress, @"1036"] parame:dic cookie:nil result:^(id result) {
...
- (void)saveAction
{
    if(_isOne){
        ...
        [HBSNetWork putUrl:[NSString stringWithFormat:@"%@cart/addressModify/%@", HBSNetAdress, @"1036"] parame:dic header:@"c02b68e88c44385f56064ce4cd49b319" cookie:nil result:^(id result) {
            if ([result[@"code"] integerValue] == 200) {
                [self.navigationController popViewControllerAnimated:YES];
            }
        }];
