...
- (void)netWorking
{
    ...
    [HBSNetWork getUrl:[NSString stringWithFormat:@"%@cart/address/%@", HBSNetAdress, @"1036"] paramaters:nil header:@"stoken" cookie:nil Result:^(id result) {
        if ([result[@"code"] integerValue] == 200) {
            ...
            UIImageView *noAdressImage = ImageAlloc(0, 64, WIDTH, HEIGHT);
            noAdressImage.image = [UIImage imageNamed:@"img_shouhuodizhiweikong@2x"];
            [self.view addSubview:noAdressImage];
        }
