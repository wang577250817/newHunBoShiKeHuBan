...
{
    UIImageView *errorImage = [[UIImageView alloc] initWithFrame:CGRectMake(0, 64, WIDTH , HEIGHT - 64)];
    errorImage.image = [UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"img_wangluoyichang@2x" ofType:@"png"]];
    [fatherView addSubview:errorImage];
}
-(BOOL)checkWIFI
{
