...
#pragma mark - 图片文字
    UILabel *label1 = [[UILabel alloc] initWithFrame:CGRectMake(insets, CHAT_BUTTON_SIZE + 5 , CHAT_BUTTON_SIZE, CHAT_BUTTON_SIZE)];
    label1.text = @"照片";
    label1.textAlignment = NSTextAlignmentCenter;
    label1.font = FONT(15);
    label1.textColor = HEISE;
...
#pragma mark - 照相文字
    UILabel *label = [[UILabel alloc] initWithFrame:CGRectMake(insets * 2 + CHAT_BUTTON_SIZE, CHAT_BUTTON_SIZE + 5 , CHAT_BUTTON_SIZE, CHAT_BUTTON_SIZE)];
    label.text = @"拍照";
    label.textAlignment = NSTextAlignmentCenter;
    label.font = FONT(15);
    label.textColor = HEISE;
