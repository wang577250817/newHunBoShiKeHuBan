...
- (void)clicktapCityLabel{
    ...
    UIAlertAction *cancleAction = [UIAlertAction actionWithTitle:@"确定" style:UIAlertActionStyleCancel handler:^(UIAlertAction * _Nonnull action) {
        ...
        //                UITableViewCell *cell=[tabView cellForRowAtIndexPath:[NSIndexPath indexPathForRow:4 inSection:0]];
        NSLog(@"城市选择%@", showMsg);
...
- (IBAction)submitBtn:(UIButton *)sender {
    ...
    if ([self checkWIFI]) {
        ...
        [HBSNetWork putUrl:[NSString stringWithFormat:@"%@user/1036",HBSNetAdress] parame:params header:nil cookie:nil result:^(id result) {
