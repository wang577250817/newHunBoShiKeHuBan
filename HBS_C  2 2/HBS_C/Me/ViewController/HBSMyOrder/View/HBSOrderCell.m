...
//    [orderModel.order_status isEqualToString:@"用户取消订单"];
...
//                self.stateLabel.text = self.cancesStr;
...
- (void)payClick:(UIButton *)btn{
    ...
    self.payDic = @{@"order_sn":self.orderSnStr,@"order_amount":self.orderAmountStr,@"order_date":self.orderAateStr, @"order_title":self.orderTitleStr}.mutableCopy;
