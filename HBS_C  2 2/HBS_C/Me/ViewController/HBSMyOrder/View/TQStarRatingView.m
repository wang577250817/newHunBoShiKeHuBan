...
{
    //    NSString * str1 = [NSString stringWithFormat:@"%0.2f",point.x / self.frame.size.width];
    //    float score1 = [str1 floatValue];
    CGPoint p = point;
    //    p.x = score1;
    ...
    if (p.x > 0 && p.x <= self.frame.size.width / 5) {
        p.x = self.frame.size.width / 5;
        
    }
    if (p.x > (self.frame.size.width / 5 + 0.01) && p.x <= self.frame.size.width / 5 * 2) {
        p.x = self.frame.size.width / 5 * 2;
        
    }
    if (p.x > (self.frame.size.width / 5*2 + 0.01) && p.x <= self.frame.size.width / 5 * 3) {
        p.x = self.frame.size.width / 5 * 3;
    }
    if (p.x > (self.frame.size.width / 5*3 + 0.01) && p.x <= self.frame.size.width / 5 * 4) {
        p.x = self.frame.size.width / 5 * 4;
    }
    if (p.x > (self.frame.size.width / 5*4 + 0.01) && p.x <= self.frame.size.width / 5 * 5) {
        p.x = self.frame.size.width / 5 * 5;
    }
