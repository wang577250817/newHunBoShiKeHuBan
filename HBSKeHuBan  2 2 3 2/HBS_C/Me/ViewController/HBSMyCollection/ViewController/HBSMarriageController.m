...
- (void)getupData{
    ...
    [HBSNetWork getUrl:[NSString stringWithFormat:@"%@user/%@/collect?user_collect_type=goods&iPageItem=20&iPageIndex=0", HBSNetAdress, [ProjectCache getLoginMessage][@"user_id"]] paramaters:paramas header:nil cookie:nil Result:^(id result) {
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    wedVC.goods_id = [self.marriageArr[indexPath.row] goods_id];
