...
@property (nonatomic, copy) NSString *order_status_id;//状态
...
@property (nonatomic, copy) NSString *order_title;//对象
@property (nonatomic, copy) NSString *order_date;//下单时间
...
@property (nonatomic, copy) NSString *order_ids;//订单id
