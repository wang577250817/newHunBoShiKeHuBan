...
- (void)okAction:(UIButton *)sender
{
    ...
    if (!sender.selected) {
        ...
        if ([_numTF.text integerValue] == 0) {
            ...
            self.endLabel = [[UILabel alloc] initWithFrame:CGRectMake(WIDTH / 2 - 90, HEIGHT / 2 - 100, 180, 25)];
...
- (void)reduceAction
{
    if ([_numTF.text integerValue] != 1) {
        ...
        self.endLabel = [[UILabel alloc] initWithFrame:CGRectMake(WIDTH / 2 - 140, HEIGHT / 2 - 100, 300, 25)];
        self.endLabel.backgroundColor = [UIColor blackColor];
