...
-(void)initChoseView
{
    ...
    choseView.lb_detail.text = @"请选择规格";
...
- (void)sureAction
{
    if ([choseView.countView.tf_count.text integerValue] == 0) {
        [self creatAlertViewOne:@"数量不能选择为0" message:@"" sureStr:@"确定" sureAction:^(id result) {
