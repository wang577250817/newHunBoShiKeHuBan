...
- (void)two
{
    ...
    //    [UIImage imageWithContentsOfFile:@""];//大的图片会一直缓存在内存中
}
- (void)wexin
{
    ...
    //            }else{
    //                UIAlertController* alertCtl = [UIAlertController alertControllerWithTitle:nil message:[json objectForKey:@"V"] preferredStyle:UIAlertControllerStyleAlert];
