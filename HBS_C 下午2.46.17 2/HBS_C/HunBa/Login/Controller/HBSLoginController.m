...
- (void)imageClick{
    ...
    [manager POST:@"http://192.168.0.82:10081/user/login" parameters:params progress:^(NSProgress * _Nonnull uploadProgress) {
        ...
        if ([responseObject[@"code"] integerValue] == 200) {
            ...
            user_im_add(responseObject[@"result"][@"user_im"]);
            user_password_add(responseObject[@"result"][@"user_password"]);
            user_id_add(responseObject[@"result"][@"user_id"]);
