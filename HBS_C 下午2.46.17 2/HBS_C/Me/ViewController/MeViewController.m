...
- (void)requestData{
    ...
    [manager GET:@"http://192.168.0.82:10081/user/1036" parameters:params progress:^(NSProgress * _Nonnull downloadProgress) {
        
    } success:^(NSURLSessionDataTask * _Nonnull task, id  _Nullable responseObject) {
        
        if ([responseObject[@"code"]integerValue] == 200) {
            self.mDic = responseObject[@"result"];
