...
- (IBAction)sureBtn:(UIButton *)sender {
    ...
    if ([self checkWIFI]) {
        ...
        if ([[self panduan][0]boolValue]) {
            [HBSNetWork putUrl:[NSString stringWithFormat:@"%@user/%@/mobile", HBSNetAdress, params[@"id"]] parame:params cookie:nil result:^(id result) {
...
- (void)sendTapAction{
    ...
    if ([self checkWIFI]) {
        ...
        [HBSNetWork postUrl:[NSString stringWithFormat:@"%@service/sms", HBSNetAdress] parame:params cookie:nil result:^(id result) {
