...
- (CGFloat)cellHeight{
    ...
    //3.底部高度
    if ([self.order_status isEqualToString:@"等待买家付款"] || [self.order_status isEqualToString:@"等待服务"] || [self.order_status isEqualToString:@"交易成功"] || [self.order_status isEqualToString:@"待发货"] || [self.order_status isEqualToString:@"卖家已发货"] || [self.order_status isEqualToString:@"待收货"] || [self.order_status isEqualToString:@"用户取消订单"] || [self.order_status isEqualToString:@"卖家已发货"]) {
        _cellHeight += 97;
    }else{
