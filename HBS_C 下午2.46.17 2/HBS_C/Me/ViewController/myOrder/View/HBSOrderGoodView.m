...
- (void)setOrderModel:(HBSOrderModel *)orderModel{
    ...
    //商品名称
        CGFloat titleLabelH = self.numBer * 12;
...
//        self.specLabel.frame = CGRectMake(95, 130 * i + specLabelH, WIDTH - 120, 15);
...
//    CGFloat moneyLabelH = self.numBer * 40;
    for (NSUInteger i = 0; i < count; i++) {
        ...
        self.amountLabel.frame = CGRectMake(95, 132 * i + 80, WIDTH - 280, 15);
    ...
    for (NSUInteger i = 0; i < count; i++) {
        ...
        self.quantityLabel.frame = CGRectMake(WIDTH - 120, 132 * i + 80, WIDTH - 280, 15);
