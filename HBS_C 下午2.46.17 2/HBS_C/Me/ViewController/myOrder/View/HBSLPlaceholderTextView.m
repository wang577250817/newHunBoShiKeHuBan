...
@implementation HBSLPlaceholderTextView
...
- (void)drawRect:(CGRect)rect
{
    if ([_placeholderText length] > 0)
    {
        ...
        {
            _placeholderLabel = [[HBSMyLabel alloc] initWithFrame:CGRectMake(8, 8, self.bounds.size.width - 16, 0)];
