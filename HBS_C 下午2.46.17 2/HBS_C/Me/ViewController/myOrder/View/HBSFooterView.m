...
#import "HBSChengViewController.h"
...
- (instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        ...
        [self.hasBtn addTarget:self action:@selector(clickHasBtn) forControlEvents:UIControlEventTouchUpInside];
...
- (void)setGoodFooterDic:(NSMutableDictionary *)goodFooterDic{
    ...
    self.moneyNumLabel.text = [NSString stringWithFormat:@"¥%@", goodFooterDic[@"order_amount"]];
...
//    HBSContactUsController *contact = [[HBSContactUsController alloc]init];
//    UITabBarController *tabBarVC = (UITabBarController *)self.window.rootViewController;
//    UINavigationController *nav = tabBarVC.selectedViewController;
//        [HBSContactUsController call:@"13342277469" inViewController:contact failBlock:^{
//            HBSLog(@"模拟器不能打电话");
//    
//        }];
     HBSLog(@"12345678");
...
- (void)clickHasBtn{
    ...
    HBSChengViewController *cheng = [[HBSChengViewController alloc]init];
    UITabBarController *tabBarVC = (UITabBarController *)self.window.rootViewController;
    UINavigationController *nav = tabBarVC.selectedViewController;
    [nav pushViewController:cheng animated:YES];
